            ...
            <div className="flex justify-center items-center min-h-screen inset-0">
                <div className="w-520 h-524 top-250 left-460 rounded-lg border border-gray-300 absolute shadow-xl p-16 bg-white">
                    <div className="w-[20.08vw] h-[45.72vh] top-[33.80vh] left-[28.96vw] gap-[2.50vw]">
                        <h1 className="font-roboto font-medium text-2xl leading-tight text-center mb-2">{message}</h1>
                        <p className="font-open-sans font-normal text-base leading-custom-21.79 text-center text-secondaryHeading">{description}</p>
                        <br />
                        <br />
                        <p className="font-open-sans font-normal text-base leading-custom-21.79 text-center text-secondaryHeading">{instructions}</p>
                        <br />
                        ...
                        <p className="font-open-sans font-normal text-base leading-custom-21.79 text-center text-secondaryHeading">
                            ...
                            <span>
                                <Link className="font-open-sans font-bold text-20 leading-27.24 text-accent text-center underline" 
                        ...
                        <div className="text-secondaryHeading font-roboto font-medium text-[12px] leading-[14.06px] text-center underline">
                            <Link className="" href="">Terms and Conditions</Link><div className="w-[2px] h-[12px] bg-current inline-block bg-accent mx-3"></div><Link href="">Privacy Policy</Link>
                        </div>
                    </div>
                </div>
            </div>
